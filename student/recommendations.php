                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="recommendations.php"><i class="menu-icon icon-list"></i>User Intent Books </a></li>
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="recommendations.php" method="post">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit"class="btn">Submit Book Intent</button>
                                            </div>
                                        </div>
                                    </form>
                            </div>
...
<?php }
    ...
    echo "press back arrow to go to login page";
} ?>